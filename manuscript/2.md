...
Since it’s rare to run into the second scenario, the only situation to really watch out for is when one writes about character references. This happens to be a scenario that takes care of itself, for you wouldn’t have a chance to make a character reference visible if you _didn’t_ escape the leading ampersand.
