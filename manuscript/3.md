...
D> There are many methods linked to the second paradigm—see e.g. [BEM](https://getbem.com/), [OOCSS](https://web.archive.org/web/20090625191515/http://oocss.org/), also [Atomic CSS](https://acss.io/)—, which gives it depth, but there’s little theoretical unity in them.
